...
const ScrapeTopPicks = async function *(_page: Page): AsyncGenerator<OptionalJob> {
...

  {
    ...
    await Promise.all([
      targetPage.goto(
        "https://www.linkedin.com/jobs/search/?currentJobId=4215571484&f_TPR=r86400&geoId=90009496&keywords=C%23%2C%20dotnet&origin=JOB_SEARCH_PAGE_SEARCH_BUTTON&refresh=true"
      ),
    ])
